...
// Componente preso da https://mui.com/material-ui/react-autocomplete/#google-maps-place
// e modificato per :
//  limitare la zona a Italia
//  ottenere coordinate dell'indirizzo
//  renderlo interagibile da un componente parent
...
export default function GoogleAutocomplete({ value, onChange, error }) {
  ...
  useEnhancedEffect(() => {
    ...
    if (inputValue === "") {
      setOptions(autocompleteValue ? [autocompleteValue] : emptyOptions);
      return undefined;
    }
  ...
  }, [autocompleteValue, inputValue, loaded]);
    ...
    <Autocomplete
      ...
      onChange={async (event, newValue) => {
        ...
        if (newValue && newValue.placeId) {
          const placeDetails = await getPlaceDetails(newValue.placeId);
